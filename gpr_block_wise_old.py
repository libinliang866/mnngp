...
class gpr():
    ...
    def block_wise_inverse(self, file):
        ...
        dat_inv_11_out = dat_inv_11 - tf.matmul(dat_inv_12_21, dat_inv_11)

        np.save(file + 'inverse_training_set' + '_' + str(0) + '_' + str(0) + '.npy',
                dat_inv_11_out[:block_size, :block_size].numpy())
...
if __name__ == '__main__':
    ...
    dat_train, y_train = get_data(split = 'train', extract_number = 10000, one_hot = True, data_set = 'mnist', shuffle = False)
